...
exports.checkNodeVersion = exports.compareVersions = exports.isVersion = void 0;
...
function checkNodeVersion(currentVersion = process.versions.node, requiredVersion = pjson.engines.node.slice(2)) {
    if (module.exports.compareVersions(currentVersion, requiredVersion) < 0) {
        ...
        console.error('Unsupported Node.js version ' + currentVersion + ', ' + 'version ' + requiredVersion + ' or later is required.');
        process.exit(1);
    }
}
