...
export var ProcessRule = /*#__PURE__*/function () {
  ...
  _createClass(ProcessRule, [{
    ...
    value: function trigger(contextIds) {
      var contextIds_ = _Array$isArray(contextIds) ? contextIds : [contextIds]; // https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/dome_process_rules_trigger.htm
...
var ApprovalProcessRequest = /*#__PURE__*/function () {
  ...
  _createClass(ApprovalProcessRequest, [{
    key: "then",
